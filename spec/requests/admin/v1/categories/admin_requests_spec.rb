...
RSpec.describe 'Admin::V1::Categories as :admin', type: :request do
  ...
  context 'POST /categories' do
    ...
    context 'with valid params' do
      ...
      it 'returns last added Category' do
        ...
        expect(body_json).to eq expected_category
      end
  ...
  context 'Delete /categories' do
    ...
    it 'remove all associated product categories' do
      ...
      delete url, headers: auth_header(user)
      expected_product_categoriers = ProductCategory.where(id: product_categories.map(&:id))
      expect(expected_product_categoriers).to eq []
    end
  end
end
